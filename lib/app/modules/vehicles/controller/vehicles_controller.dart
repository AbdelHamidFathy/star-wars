...
import 'package:star_wars/app/repositories/vehicles_repo.dart';
...
class VehiclesController extends GetxController {
  ...
  Future<void> fetchCharacters(int page) async {
    ...
    try {
      PaginatedResponse<Vehicle> paginatedResponse =
          await repository.fetchVehicles(page);

      vehicles.assignAll(paginatedResponse.results);
