...
import 'package:star_wars/app/repositories/films_repo.dart';
...
class FilmsController extends GetxController {
  ...
  Future<void> fetchCharacters(int page) async {
    ...
    try {
      PaginatedResponse<Film> paginatedResponse =
          await repository.fetchFilms(page);

      films.assignAll(paginatedResponse.results);
